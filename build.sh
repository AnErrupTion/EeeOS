...
i686-elf-gcc -c src/vga.c -o bin/vga.o -std=gnu2x -ffreestanding -O2 -Wall -Wextra
...
i686-elf-gcc -c src/ps2.c -o bin/ps2.o -std=gnu2x -ffreestanding -O2 -Wall -Wextra
